    ...
    public void saveData(Map<Long, DayTO> data, ParametersTO param) throws Exception {
        try {
            ...
            if (data != null && data.size() > 0) {
                ...
                instance.setDate(ZonedDateTime.now());
                instance.setAvanceBetasoides(param.getAvanceBetasoides());
                instance.setAvanceFerengis(param.getAvanceFerengis());
                instance.setAvanceVulcanos(param.getAvanceVulcanos());
                instance.setDistanceBetasoides(param.getDistanceBetasoides());
                instance.setDistanceFerengis(param.getDistanceFerengis());
                instance.setDistanceVulcanos(param.getDistanceVulcanos());
                instance.setInitFerengis(param.getInitFerengis());
                instance.setInitVulcanos(param.getInitVulcanos());
                instance.setInitBetasoides(param.getInitBetasoides());
                instance.setYears(param.getYear());
                Day day = null;
                DayTO dayTO = null;
